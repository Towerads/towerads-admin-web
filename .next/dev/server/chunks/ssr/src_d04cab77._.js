...
"[project]/src/app/(admin)/providers/[provider]/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ProviderDetailPage() {
    ...
    const current = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        const found = rows.find((r)=>String(r.provider || "").toLowerCase() === provider);
        return found ?? {
            provider,
            impressions: 0,
            revenue: 0,
...
//# sourceMappingURL=src_d04cab77._.js.map