...
function OrdersPage() {
    ...
    async function loadOrders() {
        try {
            setLoading(true);
            setError(null);
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"])("/admin/orders");
            setOrders(res.items || []);
        } catch (e) {
...
_s(OrdersPage, "QUGbwgQM7Y/qD0sofK8lhIzA4qY=", false, function() {
    return [
