...
function OrderPage() {
    ...
    async function load() {
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"])(`/admin/orders/${id}`);
            setOrder(res.order);
        } catch (e) {
            console.error(e);
        } finally{
    ...
    async function action(type) {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"])(`/admin/orders/${id}/${type}`, {
            method: "POST"
        });
        load();
    }
...
_s(OrderPage, "fXxYru0q2X0aAN2rZ/a+ajEMtos=", false, function() {
    return [
...
//# sourceMappingURL=src_1632ae00._.js.map